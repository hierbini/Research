...
class TestDerotatePlanet(unittest.TestCase):
    ...
    def test_get_time_in_order(self):
        ...
        order_list = list(DerotatePlanet.order_AB_date_time(H_date, H_time, K_date, K_time))
    ...
    def test_get_time_between_images(self):
        ...
        time_difference = DerotatePlanet.get_time_between_images(begin_date, begin_time, end_date, end_time)
