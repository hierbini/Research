...
class ProjectionShift:
    ...
    def plot_shifted_projection(self):
        ...
        plot_projection(self.image_name, self.planet, shifted_projection)

def plot_projection(image_name, planet, projection, ctrlon = 180, lat_limits = (-90, 90), lon_limits = (0, 360), cbarlabel = 'Count'):
    vmin, vmax = planet.vmin, planet.vmax
    fontsize = 14
